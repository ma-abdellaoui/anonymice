...
describe("exportMultiToPDF", () => {
  ...
  it("brands the generated report with Anonymice and its accent color", () => {
    exportMultiToPDF(makeMultiResult());
    const html = mockPrintWindow.document.write.mock.calls[0][0] as string;

    expect(html).toContain("Generated by Anonymice Pricing Calculator");
    expect(html).toContain("#1389A0");
    expect(html).not.toContain("Generated by LiteLLM");
